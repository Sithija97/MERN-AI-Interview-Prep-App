  ...
  return (
    <>
      <div className="w-full min-h-full bg-blue-50">
        <div className="w-[500px] h-[500px] bg-blue-200/20 blur-[65px] absolute top-0 left-0" />
        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <header className="flex justify-between items-center mb-16">
            ...
            <button
              className="bg-gradient-to-r from-[#3b82f6] to-[#1d4ed8] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-black hover:text-white border border-white transition-colors cursor-pointer"
